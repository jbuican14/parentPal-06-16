...
import { User, Mail, ArrowRight, Eye, EyeOff, Shield } from 'lucide-react';

interface RegistrationPageProps {
  onNext: (userData: { name: string; email: string }) => void;
}

const RegistrationPage: React.FC<RegistrationPageProps> = ({ onNext }) => {
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Join thousands of families staying organized with ParentPal
          </p>
        </div>
