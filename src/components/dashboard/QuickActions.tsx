        ...
        <div className="space-y-3">
          {quickActions.map((action, index) => (
            <button
              ...
              className={`w-full p-4 border-2 rounded-xl transition-all duration-200 hover:shadow-md hover:scale-105 ${action.color}`}
            >
      ...
      {conflictCount > 0 && (
        <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-orange-500">
          <div className="flex items-center mb-2">
            ...
            <h3 className="font-semibold text-orange-800">Schedule Conflicts</h3>
          </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-green-600 font-medium">At School</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-gray-600">Jake</span>
            <span className="text-sm text-green-600 font-medium">At School</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-gray-600">Mom</span>
            <span className="text-sm text-blue-600 font-medium">At Work</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-gray-600">Dad</span>
            <span className="text-sm text-blue-600 font-medium">At Work</span>
          </div>
        </div>
      </div>
